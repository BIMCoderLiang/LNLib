...
namespace LNLib
{
	...
	public:
		...
		/// </summary>
		static bool CreateRevolvedSurface(const XYZ& origin, const XYZ& axis, double rad, const std::vector<XYZW>& generatrixCurve, std::vector<double>& knotVectorU, std::vector<std::vector<XYZW>>& controlPoints);
	};
}
