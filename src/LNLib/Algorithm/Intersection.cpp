...
{
	VALIDATE_ARGUMENT(!vector0.IsZero(), "vector0", "Vector0 must not be be zero vector.");
	VALIDATE_ARGUMENT(!vector1.IsZero(), "vector1", "Vector1 must not be be zero vector.")
