...
namespace LNLibSharp
{
    public static partial class LNLibInterpolation
    {
        ...
        public static extern double LNLIB_INTERPOLATION_get_total_chord_length(
        ...
        public static extern void LNLIB_INTERPOLATION_get_chord_parameterization(
            [In] XYZ[] through_points,
            int through_points_count,
        ...
        public static extern double LNLIB_INTERPOLATION_get_centripetal_length(
            [In] XYZ[] through_points,
            int through_points_count);
        ...
        public static extern void LNLIB_INTERPOLATION_get_centripetal_parameterization(
            [In] XYZ[] through_points,
            int through_points_count,
            [Out] double[] out_params,
            [In, Out] ref int out_size);
        ...
        public static extern void LNLIB_INTERPOLATION_average_knot_vector(
            int degree,
        ...
        public static extern int LNLIB_INTERPOLATION_get_surface_mesh_parameterization(
            [In] XYZ[] through_points,
            int rows,
            int cols,
            [Out] double[] params_u,
        ...
        public static extern void LNLIB_INTERPOLATION_compute_tangent_by_three_points(
            [In] XYZ[] through_points,
            int through_points_count,
        ...
        public static extern int LNLIB_INTERPOLATION_compute_tangent_by_five_points(
            [In] XYZ[] through_points,
            int through_points_count,
            [Out] XYZ[] out_tangents,
            [In, Out] ref int out_size);
        ...
        public static extern int LNLIB_INTERPOLATION_computer_weight_for_rational_quadratic_interpolation(
            XYZ start_point,
        ...
        public static extern void LNLIB_INTERPOLATION_compute_knot_vector(
            int degree,
